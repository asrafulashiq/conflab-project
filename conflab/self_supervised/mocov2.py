...
class MocoV2(pl.LightningModule):
    ...
    def _dequeue_and_enqueue(self, keys):
        ...
        _idx = [
            i % self.hparams.num_negatives
            for i in range(ptr, ptr + batch_size)
        ]
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument('--data_dir',
                            type=str,
                            default=os.environ['HOME'] + '/dataset/')
...
def cli_main():
    ...
    trainer = pl.Trainer.from_argparse_args(args, callbacks=[scheduler])
